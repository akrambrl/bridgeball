...
// Ouvert depuis un fichier (file://), l'historique HTML5 ne fonctionne pas :
// on bascule sur un routeur à hash. En ligne (http/https) on garde les URLs
// propres de BrowserRouter.
const isFileProtocol = typeof window !== "undefined" && window.location.protocol === "file:";
const Router = isFileProtocol ? HashRouter : BrowserRouter;
const routerProps = isFileProtocol ? {} : { basename: import.meta.env.BASE_URL.replace(/\/$/, "") };
