export const PLAYERS = [
  ...
  { name:"Nilson Angulo", clubs:["Anderlecht", "Sunderland"], diff:"expert" },
  ...
  { name:"Mika Biereth", clubs:["Arsenal", "Sturm Graz", "AS Monaco"], diff:"expert" },
  { name:"Nathan Zézé", clubs:["FC Nantes", "Neom"], diff:"expert" },
  { name:"Mamadou Sarr", clubs:["Chelsea", "RC Strasbourg"], diff:"expert" },
  { name:"Brennan Johnson", clubs:["Nottingham Forest", "Tottenham", "Crystal Palace"], diff:"moyen" },
  { name:"Robert Sánchez", clubs:["Brighton", "Chelsea"], diff:"moyen" },
  { name:"Marcos Senesi", clubs:["Feyenoord", "Bournemouth"], diff:"expert" },
  { name:"Senny Mayulu", clubs:["Paris Saint-Germain"], diff:"expert" },
  { name:"Ayyoub Bouaddi", clubs:["LOSC Lille"], diff:"expert" },
  { name:"Darryl Bakola", clubs:["Olympique de Marseille", "Sassuolo"], diff:"expert" },
  { name:"Eli Kroupi", clubs:["FC Lorient", "Bournemouth"], diff:"expert" },
  { name:"George Ilenikhena", clubs:["Amiens SC", "Royal Antwerp", "AS Monaco"], diff:"expert" },
  { name:"Anthony Martial", clubs:["Olympique Lyonnais", "AS Monaco", "Manchester United", "Séville FC", "AEK Athènes", "Monterrey"], diff:"moyen" },  
  { name:"Igor Thiago", clubs:["Club Brugge", "Brentford"], diff:"expert" },
  { name:"Antoine Semenyo", clubs:["Bristol City", "Bournemouth", "Manchester City"], diff:"expert" },
  ...
  { name:"Matheus Cunha", clubs:["RB Leipzig", "Hertha Berlin", "Atlético Madrid", "Wolverhampton", "Manchester United"], diff:"moyen" },  
  ...
  { name:"Luka Vušković", clubs:["Hajduk Split", "Tottenham", "Hamburger SV"], diff:"expert" },
  { name:"Nicolas Jackson", clubs:["Villarreal", "Chelsea", "Bayern Munich"], diff:"moyen" },
  ...
  { name:"Davy Klaassen", clubs:["Ajax Amsterdam", "Everton", "Werder Bremen", "Inter Milan", "Ajax Amsterdam"], diff:"moyen" },
  ...
  { name:"Bruma", clubs:["Sporting CP", "Galatasaray", "RB Leipzig", "PSV Eindhoven", "Olympiacos", "Fenerbahce", "Braga", "Benfica"], diff:"moyen" },
  ...
  { name:"João Cancelo", clubs:["Juventus", "Manchester City", "Barcelona", "Bayern Munich", "Al Hilal", "Barcelona"], diff:"moyen" },
  ...
  { name:"Kevin De Bruyne", clubs:["Chelsea", "Wolfsburg", "Manchester City", "Napoli"], diff:"facile" },
  ...
  { name:"Jack Grealish", clubs:["Aston Villa", "Manchester City", "Everton"], diff:"moyen" },
  ...
  { name:"Heung-min Son", clubs:["Bayer Leverkusen", "Tottenham", "LAFC"], diff:"facile" },
  ...
  { name:"Memphis Depay", clubs:["PSV Eindhoven", "Manchester United", "Lyon", "Barcelona", "Atletico Madrid", "Corinthians"], diff:"moyen" },
  { name:"Jadon Sancho", clubs:["Borussia Dortmund", "Manchester United", "Chelsea", "Aston Villa"], diff:"moyen" },
  { name:"Mason Mount", clubs:["Chelsea", "Manchester United"], diff:"moyen" },
  { name:"Pierre-Emerick Aubameyang", clubs:["Borussia Dortmund", "Arsenal", "Barcelona", "Chelsea", "Marseille", "Al Qadsiah"], diff:"moyen" },
  ...
  { name:"Antony", clubs:["Ajax Amsterdam", "Manchester United", "Real Betis"], diff:"moyen" },
  { name:"Gleison Bremer", clubs:["Torino", "Juventus"], diff:"expert" },
  { name:"Alejandro Garnacho", clubs:["Manchester United", "Chelsea"], diff:"moyen" },
  ...
  { name:"Sacha Boey", clubs:["Galatasaray", "Bayern Munich", "Galatasaray"], diff:"expert" },
  ...
  { name:"Jonathan Rowe", clubs:["Norwich City", "Olympique de Marseille", "Bologna"], diff:"expert" },
...
,
  ...
  { name:"Ansu Fati", clubs:["Barcelona", "Brighton", "AS Monaco"], diff:"facile" },
...
{ name:"Mohammed Kudus", clubs:["FC Nordsjaelland", "Ajax", "West Ham United", "Tottenham Hotspur"], diff:"moyen" },
{ name:"Liam Delap", clubs:["Manchester City", "Preston North End", "Stoke City", "Hull City", "Ipswich Town", "Chelsea"], diff:"expert" },
{ name:"Castello Lukeba", clubs:["Olympique Lyonnais", "RB Leipzig"], diff:"expert" },
{ name:"Ferdi Kadioglu", clubs:["Fenerbahçe", "Brighton"], diff:"expert" },
{ name:"Milos Kerkez", clubs:["AC Milan", "AZ Alkmaar", "Bournemouth", "Liverpool"], diff:"expert" },
...
{ name:"Jaden Philogene", clubs:["Aston Villa", "Stoke City", "Cardiff City", "Hull City", "Ipswich Town"], diff:"expert" },
...
{ name:"Diego Maradona", clubs:["Argentinos Juniors", "Boca Juniors", "FC Barcelone", "Napoli", "Séville"], diff:"facile" },
...
{ name:"Michel Platini", clubs:["AS Nancy", "AS Saint-Étienne", "Juventus"], diff:"facile" },
{ name:"Gerd Müller", clubs:["Bayern Munich", "Fort Lauderdale Strikers"], diff:"moyen" },
{ name:"Luis Figo", clubs:["Sporting CP", "FC Barcelone", "Real Madrid", "Inter Milan"], diff:"facile" },
{ name:"Gabriel Batistuta", clubs:["Boca Juniors", "Fiorentina", "AS Roma", "Inter Milan", "Al-Arabi"], diff:"moyen" },
{ name:"Hernán Crespo", clubs:["Parme", "Lazio", "Inter Milan", "Chelsea", "AC Milan", "Genoa"], diff:"moyen" },
{ name:"Gianfranco Zola", clubs:["Napoli", "Parme", "Chelsea", "Cagliari"], diff:"moyen" },
{ name:"Gary Lineker", clubs:["Leicester City", "Everton", "FC Barcelone", "Tottenham", "Nagoya Grampus"], diff:"moyen" },
{ name:"Ryan Giggs", clubs:["Manchester United"], diff:"facile" },
{ name:"Gianluigi Buffon", clubs:["Parme", "Juventus", "Paris Saint-Germain"], diff:"facile" },
{ name:"Petr Čech", clubs:["Chmel Blšany", "Sparta Prague", "Rennes", "Chelsea", "Arsenal"], diff:"moyen" },
{ name:"Philipp Lahm", clubs:["Bayern Munich", "VfB Stuttgart"], diff:"moyen" },
{ name:"Djibril Cissé", clubs:["AJ Auxerre", "Liverpool", "OM", "Sunderland", "Panathinaïkos", "Lazio", "QPR", "Kuban Krasnodar"], diff:"moyen" },
{ name:"Juan Román Riquelme", clubs:["Boca Juniors", "FC Barcelone", "Villarreal", "Argentinos Juniors"], diff:"moyen" },
{ name:"Pavel Nedvěd", clubs:["Sparta Prague", "Lazio", "Juventus"], diff:"moyen" },
{ name:"Yaya Touré", clubs:["Beveren", "Metalurh Donetsk", "Olympiakos", "AS Monaco", "FC Barcelone", "Manchester City"], diff:"moyen" },
{ name:"Mario Balotelli", clubs:["Inter Milan", "Manchester City", "AC Milan", "Liverpool", "Nice", "OM", "Brescia", "Monza", "Adana Demirspor", "Sion"], diff:"facile" },
...
{ name:"Vincent Kompany", clubs:["Anderlecht", "Hambourg", "Manchester City"], diff:"moyen" },
{ name:"Laurent Blanc", clubs:["Montpellier", "Napoli", "Nîmes", "AS Saint-Étienne", "AJ Auxerre", "FC Barcelone", "OM", "Inter Milan", "Manchester United"], diff:"expert" },
{ name:"Fabien Barthez", clubs:["Toulouse", "OM", "AS Monaco", "Manchester United", "Nantes"], diff:"moyen" },
...
{ name:"Gervinho", clubs:["Beveren", "Le Mans", "LOSC Lille", "Arsenal", "AS Roma", "Hebei Fortune", "Parme", "Trabzonspor", "Aris"], diff:"moyen" },
{ name:"Hatem Ben Arfa", clubs:["Olympique Lyonnais", "OM", "Newcastle", "Hull City", "Nice", "PSG", "Rennes", "Valladolid", "Bordeaux", "LOSC Lille"], diff:"moyen" },
{ name:"Bacary Sagna", clubs:["AJ Auxerre", "Arsenal", "Manchester City", "Benevento", "Montréal"], diff:"moyen" },
{ name:"Loïc Rémy", clubs:["OM", "Nice", "QPR", "Newcastle", "Chelsea", "Crystal Palace", "Las Palmas", "Getafe", "LOSC Lille", "Benevento", "Caen", "Brest"], diff:"moyen" },
{ name:"Steve Mandanda", clubs:["Le Havre", "OM", "Crystal Palace", "Rennes"], diff:"moyen" },
  ...
  { name:"Eric Dier", clubs:["Sporting CP", "Tottenham", "Bayern Munich", "AS Monaco"], diff:"moyen" },
  ...
  { name:"Kieran Tierney", clubs:["Celtic", "Arsenal", "Real Sociedad", "Celtic"], diff:"moyen" },
  ...
  { name:"Tim Weah", clubs:["Paris Saint-Germain", "Celtic", "LOSC Lille", "Juventus", "Olympique de Marseille"], diff:"moyen" },  { name:"Folarin Balogun", clubs:["Arsenal", "Monaco"], diff:"moyen" },
  ...
  { name:"Hirving Lozano", clubs:["PSV Eindhoven", "Napoli", "San Diego FC"], diff:"moyen" },
  ...
  { name:"Lucas Paquetá", clubs:["AC Milan", "Lyon", "West Ham", "Flamengo"], diff:"moyen" },
  { name:"Éder Militão", clubs:["Porto", "Real Madrid"], diff:"moyen" },
  { name:"Alex Sandro", clubs:["Porto", "Juventus", "Flamengo"], diff:"moyen" },
  ...
  { name:"Jeremie Frimpong", clubs:["Celtic", "Bayer Leverkusen", "Liverpool"], diff:"moyen" },
  ...
  { name:"Niclas Füllkrug", clubs:["Werder Bremen", "Borussia Dortmund", "West Ham", "AC Milan"], diff:"moyen" },
  { name:"Robin Gosens", clubs:["Atalanta", "Inter Milan", "Union Berlin"], diff:"moyen" },
  { name:"Pascal Groß", clubs:["Brighton", "Borussia Dortmund", "Brighton"], diff:"expert" },
  ...
  { name:"João Palhinha", clubs:["Sporting CP", "Fulham", "Bayern Munich", "Tottenham"], diff:"moyen" },
  ...
  { name:"Simon Adingra", clubs:["Union Saint-Gilloise", "Brighton", "Sunderland", "AS Monaco"], diff:"moyen" },
  ...
  { name:"Ademola Lookman", clubs:["Everton", "RB Leipzig", "Atalanta", "Atletico Madrid"], diff:"moyen" },
  ...
  { name:"Iliman Ndiaye", clubs:["Sheffield United", "Marseille", "Everton"], diff:"moyen" },
  ...
  { name:"Ismaël Bennacer", clubs:["Arsenal", "Empoli", "AC Milan", "Olympique de Marseille", "Dinamo Zagreb"], diff:"moyen" },  { name:"Ramy Bensebaini", clubs:["Nice", "Borussia Mönchengladbach", "Borussia Dortmund"], diff:"moyen" },
  ...
  { name:"Brahim Díaz", clubs:["Manchester City", "Real Madrid", "AC Milan"], diff:"moyen" },
