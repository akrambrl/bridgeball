\f0\fs24 \cf0 export const PLAYERS = [\
  ...
  \{ name:"Joaqu\'edn Panichelli", clubs:["Deportivo Alav\'e9s", "CD Mirand\'e9s", "RC Strasbourg"], diff:"expert" \},\
  ...
  \{ name:"Igor Paix\'e3o", clubs:["Coritiba", "Feyenoord", "Marseille"], diff:"moyen" \},\
  ...
  \{ name:"Piero Hincapi\'e9", clubs:["Talleres", "Bayer Leverkusen"], diff:"moyen" \},\
  \{ name:"Ra\'fal Jim\'e9nez", clubs:["Atletico Madrid", "Benfica", "Wolverhampton", "Fulham"], diff:"moyen" \},\
  ...
  \{ name:"Est\'eav\'e3o Willian", clubs:["Palmeiras", "Chelsea"], diff:"moyen" \},\
  \{ name:"Brennan Johnson", clubs:["Nottingham Forest", "Tottenham"], diff:"moyen" \},\
  \{ name:"Robert S\'e1nchez", clubs:["Brighton", "Chelsea"], diff:"moyen" \},\
  ...
  \{ name:"Benjamin \'8ae\'9ako", clubs:["Salzburg", "RB Leipzig", "Manchester United"], diff:"moyen" \},\
  \{ name:"Bryan Mbeumo", clubs:["Troyes", "Brentford", "Manchester United"], diff:"moyen" \},\
  \{ name:"Hugo Ekitik\'e9", clubs:["Reims", "PSG", "Eintracht Frankfurt", "Liverpool"], diff:"moyen" \},\
  \{ name:"Jo\'e3o Pedro", clubs:["Watford", "Brighton", "Chelsea"], diff:"moyen" \},\
  \{ name:"Max Dowman", clubs:["Arsenal"], diff:"expert" \},\
  \{ name:"Marc Gu\'e9hi", clubs:["Chelsea", "Swansea", "Crystal Palace"], diff:"moyen" \},\
  ...
  \{ name:"Sidiki Ch\'e9rif", clubs:["Angers"], diff:"expert" \},\
  ...
  \{ name:"Pierre-Emile H\'f8jbjerg", clubs:["Bayern Munich", "Southampton", "Tottenham", "Marseille"], diff:"moyen" \},\
  \{ name:"Mason Greenwood", clubs:["Manchester United", "Getafe", "Marseille"], diff:"moyen" \},\
  \{ name:"D\'e9sir\'e9 Dou\'e9", clubs:["Rennes", "PSG"], diff:"moyen" \},\
  \{ name:"Luis D\'edaz", clubs:["Porto", "Liverpool", "Bayern Munich"], diff:"moyen" \},\
  ...
  \{ name:"Haris Tabakovi\uc0\u263 ", clubs:["Borussia Monchengladbach"], diff:"expert" \},\
  ...
  \{ name:"Sa\'efd El Mala", clubs:["Cologne"], diff:"expert" \},\
  \{ name:"Jonathan Burkardt", clubs:["Mainz", "Eintracht Frankfurt"], diff:"moyen" \},\
  \{ name:"Luka Vu\'9akovi\uc0\u263 ", clubs:["Hamburger SV"], diff:"expert" \},\
  ...
  \{ name:"F\'e1bio Vieira", clubs:["Porto", "Arsenal", "Hamburger SV"], diff:"expert" \},\
  \{ name:"Albian Hajdari", clubs:["Lugano", "Hoffenheim"], diff:"expert" \},\
  \{ name:"Far\'e8s Cha\'efbi", clubs:["Toulouse", "Eintracht Frankfurt"], diff:"expert" \},\
  \{ name:"Karim Adeyemi", clubs:["Salzburg", "Borussia Dortmund"], diff:"moyen" \},\
  \{ name:"Mario G\'f6tze", clubs:["Borussia Dortmund", "Bayern Munich", "PSV Eindhoven", "Eintracht Frankfurt"], diff:"moyen" \},\
  ...
  \{ name:"\'c1lex Grimaldo", clubs:["Barcelona", "Benfica", "Bayer Leverkusen"], diff:"moyen" \},\
  \{ name:"Marcel Sabitzer", clubs:["RB Leipzig", "Bayern Munich", "Manchester United", "Borussia Dortmund"], diff:"moyen" \},\
  \{ name:"Niklas S\'fcle", clubs:["Hoffenheim", "Bayern Munich", "Borussia Dortmund"], diff:"moyen" \},\
  \{ name:"P\'e9ter Gul\'e1csi", clubs:["Liverpool", "RB Leipzig"], diff:"moyen" \},\
  \{ name:"Rapha\'ebl Guerreiro", clubs:["Lorient", "Borussia Dortmund", "Bayern Munich"], diff:"moyen" \},\
  \{ name:"Aleksandar Pavlovi\uc0\u263 ", clubs:["Bayern Munich"], diff:"expert" \},\
  \{ name:"Josip Stani\'9ai\uc0\u263 ", clubs:["Bayern Munich", "Bayer Leverkusen"], diff:"expert" \},\
  \{ name:"Nadiem Amiri", clubs:["Hoffenheim", "Bayer Leverkusen", "Mainz"], diff:"expert" \},\
  \{ name:"Alexander N\'fcbel", clubs:["Schalke", "Bayern Munich", "Stuttgart"], diff:"expert" \},\
  \{ name:"Hiroki It\uc0\u333 ", clubs:["Stuttgart", "Bayern Munich"], diff:"expert" \},\
  ...
  \{ name:"K\uc0\u333 dai Sano", clubs:["NEC Nijmegen"], diff:"expert" \},\
  \{ name:"Sean Steur", clubs:["Ajax Amsterdam"], diff:"expert" \},\
  \{ name:"Remko Pasveer", clubs:["Heracles", "Ajax Amsterdam"], diff:"expert" \},\
  \{ name:"Ivan Peri\'9ai\uc0\u263 ", clubs:["Borussia Dortmund", "Bayern Munich", "Inter Milan", "Tottenham", "PSV Eindhoven"], diff:"moyen" \},\
  ...
  \{ name:"Mateo Ch\'e1vez", clubs:["AZ"], diff:"expert" \},\
  ...
  \{ name:"Andr\'e9 Ayew", clubs:["Marseille", "Swansea", "West Ham", "Fenerbahce", "NAC Breda"], diff:"moyen" \},\
  ...
  \{ name:"Sergi\'f1o Dest", clubs:["Ajax Amsterdam", "Barcelona", "AC Milan", "PSV Eindhoven"], diff:"moyen" \},\
  \{ name:"S\'e9bastien Haller", clubs:["Ajax Amsterdam", "Borussia Dortmund", "Utrecht"], diff:"moyen" \},\
  ...
  \{ name:"Luis Su\'e1rez", clubs:["Sporting CP"], diff:"expert" \},\
  \{ name:"Vang\'e9lis Pavl\'eddis", clubs:["AZ", "Benfica"], diff:"moyen" \},\
  \{ name:"Yanis Begraoui", clubs:["Estoril"], diff:"expert" \},\
  \{ name:"Samu Aghehowa", clubs:["Porto"], diff:"expert" \},\
  \{ name:"Jes\'fas Andr\'e9s", clubs:["Nacional"], diff:"expert" \},\
  \{ name:"Francisco Trinc\'e3o", clubs:["Barcelona", "Sporting CP"], diff:"moyen" \},\
  ...
  \{ name:"Jo\'e3o Carvalho", clubs:["Benfica", "Nottingham Forest", "Estoril"], diff:"expert" \},\
  ...
  \{ name:"Richard R\'edos", clubs:["Palmeiras", "Benfica"], diff:"expert" \},\
  \{ name:"An\'edsio Cabral", clubs:["Benfica"], diff:"expert" \},\
  \{ name:"Seko Fofana", clubs:["Lens", "Porto"], diff:"moyen" \},\
  \{ name:"Deniz G\'fcl", clubs:["Porto"], diff:"expert" \},\
  \{ name:"Nicol\'e1s Otamendi", clubs:["Valencia", "Manchester City", "Benfica"], diff:"moyen" \},\
  \{ name:"Pedro Gon\'e7alves", clubs:["Sporting CP"], diff:"expert" \},\
  ...
  \{ name:"Ant\'f3nio Silva", clubs:["Benfica"], diff:"moyen" \},\
  \{ name:"Gon\'e7alo In\'e1cio", clubs:["Sporting CP"], diff:"expert" \},\
  \{ name:"Orkun K\'f6k\'e7\'fc", clubs:["Feyenoord", "Benfica"], diff:"moyen" \},\
  ...
  \{ name:"Jo\'e3o Moutinho", clubs:["Sporting CP", "Porto", "Monaco", "Wolverhampton"], diff:"moyen" \},\
  \{ name:"Maximiliano Ara\'fajo", clubs:["Sporting CP", "Braga"], diff:"expert" \},\
  \{ name:"F\'f3tis Ioann\'eddis", clubs:["Sporting CP"], diff:"expert" \},\
  \{ name:"Dodi Luk\'e9bakio", clubs:["Watford", "Hertha Berlin", "Sevilla", "Benfica"], diff:"moyen" \},\
  \{ name:"Florentino Lu\'eds", clubs:["Benfica", "Monaco"], diff:"expert" \},\
  ...
  \{ name:"Tom\'e1s Ara\'fajo", clubs:["Benfica"], diff:"expert" \},\
  ...
  \{ name:"Eldor Shomurodov", clubs:["Roma", "\uc0\u304 stanbul Ba\u351 ak\u351 ehir"], diff:"expert" \},\
  ...
  \{ name:"N'Golo Kant\'e9", clubs:["Leicester City", "Chelsea", "Al Ittihad", "Fenerbahce"], diff:"facile" \},\
  \{ name:"Bar\uc0\u305 \u351  Alper Y\u305 lmaz", clubs:["Galatasaray"], diff:"expert" \},\
  \{ name:"Noa Lang", clubs:["Ajax Amsterdam", "Club Brugge", "PSV Eindhoven", "Galatasaray"], diff:"moyen" \},\
  \{ name:"Y\'e1ser Asprilla", clubs:["Watford", "Fenerbahce"], diff:"expert" \},\
  \{ name:"Ernest Mu\'e7i", clubs:["Besiktas"], diff:"expert" \},\
  \{ name:"G\'f6ktan G\'fcrp\'fcz", clubs:["Trabzonspor", "Besiktas"], diff:"expert" \},\
  \{ name:"Mohamed Bayo", clubs:["Clermont", "Galatasaray", "Gaziantep"], diff:"expert" \},\
  \{ name:"Felipe Augusto", clubs:["Trabzonspor"], diff:"expert" \},\
  \{ name:"Kerem Akt\'fcrko\uc0\u287 lu", clubs:["Galatasaray", "Benfica"], diff:"moyen" \},\
  \{ name:"Renato Nhaga", clubs:["Galatasaray"], diff:"expert" \},\
  \{ name:"V\'e1clav \uc0\u268 ern\'fd", clubs:["Twente", "Wolfsburg", "Besiktas"], diff:"expert" \},\
  \{ name:"Matt\'e9o Guendouzi", clubs:["Arsenal", "Marseille", "Fenerbahce"], diff:"moyen" \},\
  \{ name:"Emmanuel Agbadou", clubs:["Reims", "Wolfsburg", "Besiktas"], diff:"expert" \},\
  \{ name:"Nene Dorgeles", clubs:["Fenerbahce"], diff:"expert" \},\
  \{ name:"Yunus Akg\'fcn", clubs:["Galatasaray", "Leicester City"], diff:"expert" \},\
  \{ name:"Leroy San\'e9", clubs:["Manchester City", "Bayern Munich", "Galatasaray"], diff:"facile" \},\
  \{ name:"Christ Inao Oula\'ef", clubs:["Trabzonspor"], diff:"expert" \},\
  \{ name:"Milan \'8akriniar", clubs:["Inter Milan", "PSG", "Fenerbahce"], diff:"moyen" \},\
  \{ name:"U\uc0\u287 urcan \'c7ak\u305 r", clubs:["Trabzonspor", "Galatasaray"], diff:"expert" \},\
  ...
  \{ name:"\uc0\u304 rfan Can Kahveci", clubs:["Fenerbahce", "Kas\u305 mpa\u351 a"], diff:"expert" \},\
  \{ name:"Umut Nayir", clubs:["Trabzonspor"], diff:"expert" \},\
  \{ name:"Alexandru Maxim", clubs:["Stuttgart", "Mainz", "Gaziantep"], diff:"expert" \},\
  \{ name:"Bartu\uc0\u287  Elmaz", clubs:["Karag\'fcmr\'fck"], diff:"expert" \},\
  \{ name:"Cenk Tosun", clubs:["Besiktas", "Everton", "Kas\uc0\u305 mpa\u351 a"], diff:"moyen" \},\
  \{ name:"Yasin \'d6zcan", clubs:["Besiktas"], diff:"expert" \},\
  ...
  \{ name:"Yi\uc0\u287 it Efe Demir", clubs:["Fenerbahce"], diff:"expert" \},\
  \{ name:"Oh Hyeon-gyu", clubs:["Celtic", "RC Strasbourg", "Besiktas"], diff:"expert" \},\
  \{ name:"Armando G\'fcner", clubs:["Galatasaray"], diff:"expert" \},\
  \{ name:"Semih K\uc0\u305 l\u305 \'e7soy", clubs:["Besiktas"], diff:"expert" \},\
  \{ name:"Kerem Demirbay", clubs:["Bayer Leverkusen", "Galatasaray", "Kas\uc0\u305 mpa\u351 a"], diff:"moyen" \},\
  \{ name:"G\'fcven Yal\'e7\uc0\u305 n", clubs:["Alanyaspor"], diff:"expert" \},\
  \{ name:"El Bilal Tour\'e9", clubs:["Almeria", "Atalanta", "Besiktas"], diff:"moyen" \},\
  \{ name:"Gabriel Sara", clubs:["Norwich City", "Galatasaray"], diff:"expert" \},\
  \{ name:"Amir Murillo", clubs:["Anderlecht", "Besiktas"], diff:"expert" \},\
  \{ name:"Davinson S\'e1nchez", clubs:["Ajax Amsterdam", "Tottenham", "Galatasaray"], diff:"moyen" \},\
  \{ name:"Juli\'e1n Qui\'f1ones", clubs:["Club Am\'e9rica", "Al Qadsiah"], diff:"expert" \},\
  \{ name:"Roger Mart\'ednez", clubs:["Club Am\'e9rica", "Al Taawon"], diff:"expert" \},\
  \{ name:"Jo\'e3o F\'e9lix", clubs:["Atletico Madrid", "Chelsea", "Barcelona", "Al Nassr"], diff:"moyen" \},\
  \{ name:"Joshua King", clubs:["Manchester United", "Bournemouth", "Everton", "Al Qadsiah"], diff:"moyen" \},\
  \{ name:"K\'f3stas Forto\'fanis", clubs:["Bayer Leverkusen", "Olympiacos", "Al Qadsiah"], diff:"expert" \},\
  \{ name:"Mateo Retegui", clubs:["Tigre", "Genoa", "Atalanta", "Al Qadsiah"], diff:"moyen" \},\
  \{ name:"Sadio Man\'e9", clubs:["Liverpool", "Bayern Munich", "Al Nassr"], diff:"facile" \},\
  \{ name:"Georginio Wijnaldum", clubs:["PSV Eindhoven", "Newcastle", "Liverpool", "PSG", "Al-Ettifaq"], diff:"moyen" \},\
  \{ name:"Darwin N\'fa\'f1ez", clubs:["Almeria", "Benfica", "Liverpool", "Al Hilal"], diff:"moyen" \},\
  ...
  \{ name:"Yusuf Ak\'e7i\'e7ek", clubs:["Al Hilal"], diff:"expert" \},\
  \{ name:"Th\'e9o Hernandez", clubs:["Real Madrid", "AC Milan", "Al Hilal"], diff:"moyen" \},\
  \{ name:"Sa\'efmon Bouabr\'e9", clubs:["Al Hilal"], diff:"expert" \},\
  \{ name:"\'c2ngelo", clubs:["Santos", "Chelsea", "Al Nassr"], diff:"expert" \},\
  \{ name:"Pablo Mar\'ed", clubs:["Arsenal", "Monza", "Al Hilal"], diff:"expert" \},\
  \{ name:"Salem Al-Dawsari", clubs:["Al Hilal"], diff:"expert" \},\
  \{ name:"Ot\'e1vio Edmilson", clubs:["Porto", "Al Nassr", "Al Qadsiah"], diff:"expert" \},\
  \{ name:"Jo\'e3o Cancelo", clubs:["Juventus", "Manchester City", "Barcelona", "Bayern Munich", "Al Hilal"], diff:"moyen" \},\
  \{ name:"R\'faben Neves", clubs:["Porto", "Wolverhampton", "Al Hilal"], diff:"moyen" \},\
  \{ name:"Abderrazak Hamed Allah", clubs:["Al Shabab"], diff:"expert" \},\
  \{ name:"Jhon Dur\'e1n", clubs:["Chicago Fire", "Aston Villa", "Al Nassr"], diff:"moyen" \},\
  \{ name:"Yassine Bounou", clubs:["Girona", "Sevilla", "Al Hilal"], diff:"moyen" \},\
  \{ name:"Marcelo Brozovi\uc0\u263 ", clubs:["Inter Milan", "Al Nassr"], diff:"moyen" \},\
  \{ name:"Sergej Milinkovi\uc0\u263 -Savi\u263 ", clubs:["Lazio", "Al Hilal"], diff:"moyen" \},\
  ...
  \{ name:"\'cd\'f1igo Mart\'ednez", clubs:["Athletic Bilbao", "Barcelona", "Al Nassr"], diff:"moyen" \},\
  \{ name:"Nawaf Al-Aqidi", clubs:["Al Nassr"], diff:"expert" \},\
  \{ name:"Franck Kessi\'e9", clubs:["Atalanta", "AC Milan", "Barcelona", "Al Ahli"], diff:"moyen" \},\
  \{ name:"\'c9douard Mendy", clubs:["Chelsea", "Al Ahli"], diff:"moyen" \},\
  ...
  \{ name:"Roger Iba\'f1ez", clubs:["Atalanta", "Roma", "Al Ahli"], diff:"moyen" \},\
...
\
  ...
  \{ name:"J\'fcrgen Klinsmann", clubs:["Bayern Munich", "Tottenham"], diff:"moyen" \},\
...
\
  // \'c9quipe nationale Pologne 2026\
  \{ name:"Piotr Zieli\uc0\u324 ski", clubs:["Napoli", "Inter Milan"], diff:"moyen" \},\
  \{ name:"Arkadiusz Milik", clubs:["Ajax Amsterdam", "Napoli", "Juventus"], diff:"moyen" \},\
  \{ name:"Sebastian Szyma\uc0\u324 ski", clubs:["Feyenoord", "Fenerbah\'e7e"], diff:"moyen" \},\
  \{ name:"Matty Cash", clubs:["Nottingham Forest", "Aston Villa"], diff:"moyen" \},\
  \{ name:"Jakub Kami\uc0\u324 ski", clubs:["Wolfsburg", "FC Cologne"], diff:"moyen" \},\
  \{ name:"Przemys\uc0\u322 aw Frankowski", clubs:["Lens", "Rennes"], diff:"expert" \},\
\
  // \'c9quipe nationale \'c9cosse 2026\
...
\
  // \'c9quipe nationale Turquie 2026\
  \{ name:"Kenan Y\uc0\u305 ld\u305 z", clubs:["Juventus"], diff:"expert" \},\
  \{ name:"Ferdi Kad\uc0\u305 o\u287 lu", clubs:["Fenerbah\'e7e", "Brighton"], diff:"moyen" \},\
  \{ name:"Altay Bay\uc0\u305 nd\u305 r", clubs:["Fenerbah\'e7e", "Manchester United"], diff:"moyen" \},\
  \{ name:"Zeki \'c7elik", clubs:["Lille", "Roma"], diff:"moyen" \},\
  \{ name:"\'c7a\uc0\u287 lar S\'f6y\'fcnc\'fc", clubs:["Leicester City", "Atletico Madrid"], diff:"moyen" \},\
\
  // \'c9quipe nationale Serbie\
  \{ name:"Du\'9aan Vlahovi\uc0\u263 ", clubs:["Fiorentina", "Juventus"], diff:"moyen" \},\
  \{ name:"Aleksandar Mitrovi\uc0\u263 ", clubs:["Fulham", "Al Hilal"], diff:"moyen" \},\
  \{ name:"Du\'9aan Tadi\uc0\u263 ", clubs:["Southampton", "Ajax Amsterdam", "Fenerbah\'e7e"], diff:"moyen" \},\
  \{ name:"Luka Jovi\uc0\u263 ", clubs:["Real Madrid", "Fiorentina", "AC Milan"], diff:"moyen" \},\
  \{ name:"Filip Kosti\uc0\u263 ", clubs:["Eintracht Frankfurt", "Juventus"], diff:"moyen" \},\
  \{ name:"Nikola Milenkovi\uc0\u263 ", clubs:["Fiorentina", "Nottingham Forest"], diff:"moyen" \},\
  \{ name:"Strahinja Pavlovi\uc0\u263 ", clubs:["RB Salzburg", "AC Milan"], diff:"moyen" \},\
\
  // \'c9quipe nationale Danemark 2026\
  ...
  \{ name:"Christian N\'f8rgaard", clubs:["Brentford", "Arsenal"], diff:"moyen" \},\
  \{ name:"Joakim M\'e6hle", clubs:["Atalanta", "Wolfsburg"], diff:"expert" \},\
  \{ name:"Gustav Isaksen", clubs:["Midtjylland", "Lazio"], diff:"expert" \},\
  \{ name:"Jesper Lindstr\'f8m", clubs:["Eintracht Frankfurt", "Wolfsburg"], diff:"expert" \},\
\
  // \'c9quipe nationale Cor\'e9e du Sud 2026\
...
\
  // \'c9quipe nationale \'c9tats-Unis 2026\
  ...
  \{ name:"Gio Reyna", clubs:["Borussia Dortmund", "Borussia M\'f6nchengladbach"], diff:"moyen" \},\
  \{ name:"Chris Richards", clubs:["Hoffenheim", "Crystal Palace"], diff:"expert" \},\
\
  // \'c9quipe nationale Croatie 2026\
  \{ name:"Mateo Kova\uc0\u269 i\u263 ", clubs:["Inter Milan", "Chelsea", "Manchester City"], diff:"moyen" \},\
  \{ name:"Andrej Kramari\uc0\u263 ", clubs:["Leicester City", "Hoffenheim"], diff:"moyen" \},\
  \{ name:"Dominik Livakovi\uc0\u263 ", clubs:["Dinamo Zagreb", "Fenerbah\'e7e"], diff:"moyen" \},\
  \{ name:"Nikola Vla\'9ai\uc0\u263 ", clubs:["Everton", "CSKA Moscow", "Torino"], diff:"moyen" \},\
  \{ name:"Mario Pa\'9aali\uc0\u263 ", clubs:["Chelsea", "Atalanta"], diff:"expert" \},\
  \{ name:"Duje \uc0\u262 aleta-Car", clubs:["Marseille", "Southampton"], diff:"expert" \},\
\
  // \'c9quipe nationale Uruguay 2026\
  ...
  \{ name:"Nicol\'e1s De La Cruz", clubs:["River Plate", "Liverpool"], diff:"moyen" \},\
  \{ name:"Ronald Ara\'fajo", clubs:["Barcelona"], diff:"expert" \},\
  \{ name:"Jos\'e9 Mar\'eda Gim\'e9nez", clubs:["Atletico Madrid"], diff:"expert" \},\
\
  // \'c9quipe nationale Colombie 2026\
  \{ name:"D\'e1vinson S\'e1nchez", clubs:["Ajax Amsterdam", "Tottenham", "Galatasaray"], diff:"moyen" \},\
  \{ name:"Jhon Duran", clubs:["Aston Villa", "Al Qadsiah"], diff:"moyen" \},\
  \{ name:"Yerry Mina", clubs:["Barcelona", "Everton"], diff:"moyen" \},\
  \{ name:"Daniel Mu\'f1oz", clubs:["Genk", "Crystal Palace"], diff:"moyen" \},\
  \{ name:"Jefferson Lerma", clubs:["Bournemouth", "Crystal Palace"], diff:"moyen" \},\
  \{ name:"David Ospina", clubs:["Arsenal", "Napoli"], diff:"moyen" \},\
  \{ name:"Jhon Lucum\'ed", clubs:["Genk", "Bologna"], diff:"expert" \},\
  \{ name:"Rafael Borr\'e9", clubs:["River Plate", "Eintracht Frankfurt"], diff:"expert" \},\
\
  // \'c9quipe nationale Mexique 2026\
  \{ name:"Santiago Gim\'e9nez", clubs:["Feyenoord", "AC Milan"], diff:"moyen" \},\
  \{ name:"Hirving Lozano", clubs:["PSV Eindhoven", "Napoli"], diff:"moyen" \},\
  \{ name:"Edson \'c1lvarez", clubs:["Ajax Amsterdam", "West Ham"], diff:"moyen" \},\
  \{ name:"Jorge S\'e1nchez", clubs:["Ajax Amsterdam", "Porto"], diff:"expert" \},\
  \{ name:"C\'e9sar Montes", clubs:["Almer\'eda"], diff:"expert" \},\
  \{ name:"Guillermo Ochoa", clubs:["M\'e1laga", "Standard Li\'e8ge"], diff:"expert" \},\
\
  // \'c9quipe nationale Argentine 2026 (compl\'e9ments)\
  \{ name:"Emiliano Mart\'ednez", clubs:["Arsenal", "Aston Villa"], diff:"moyen" \},\
  \{ name:"Juli\'e1n \'c1lvarez", clubs:["River Plate", "Manchester City", "Atletico Madrid"], diff:"moyen" \},\
  ...
  \{ name:"Nicol\'e1s Tagliafico", clubs:["Ajax Amsterdam", "Lyon"], diff:"moyen" \},\
...
\
  // \'c9quipe nationale Br\'e9sil 2026 (compl\'e9ments)\
  \{ name:"Raphinha", clubs:["Leeds United", "Barcelona"], diff:"moyen" \},\
  \{ name:"Lucas Paquet\'e1", clubs:["AC Milan", "Lyon", "West Ham"], diff:"moyen" \},\
  \{ name:"\'c9der Milit\'e3o", clubs:["Porto", "Real Madrid"], diff:"moyen" \},\
  \{ name:"Alex Sandro", clubs:["Porto", "Juventus"], diff:"moyen" \},\
  \{ name:"Richarlison", clubs:["Everton", "Tottenham"], diff:"moyen" \},\
\
  // \'c9quipe nationale Suisse 2026 (compl\'e9ments)\
  \{ name:"Manuel Akanji", clubs:["Borussia Dortmund", "Manchester City"], diff:"moyen" \},\
  \{ name:"Yann Sommer", clubs:["Borussia M\'f6nchengladbach", "Bayern Munich", "Inter Milan"], diff:"moyen" \},\
  \{ name:"Breel Embolo", clubs:["Schalke", "Borussia M\'f6nchengladbach", "Monaco"], diff:"moyen" \},\
...
\
  // \'c9quipe nationale Pays-Bas 2026 (compl\'e9ments)\
  ...
  \{ name:"Nathan Ak\'e9", clubs:["Chelsea", "Manchester City"], diff:"moyen" \},\
  \{ name:"Bart Verbruggen", clubs:["Anderlecht", "Brighton"], diff:"expert" \},\
\
  // \'c9quipe nationale Italie 2026 (compl\'e9ments)\
...
\
  // \'c9quipe nationale Belgique 2026\
  \{ name:"J\'e9r\'e9my Doku", clubs:["Rennes", "Manchester City"], diff:"moyen" \},\
...
\
  // \'c9quipe nationale Angleterre 2026 (compl\'e9ments)\
...
\
  // \'c9quipe nationale Allemagne 2026 (compl\'e9ments)\
  \{ name:"Niclas F\'fcllkrug", clubs:["Werder Bremen", "Borussia Dortmund", "West Ham"], diff:"moyen" \},\
  \{ name:"Robin Gosens", clubs:["Atalanta", "Inter Milan", "Union Berlin"], diff:"moyen" \},\
  \{ name:"Pascal Gro\'df", clubs:["Brighton", "Borussia Dortmund"], diff:"expert" \},\
  \{ name:"David Raum", clubs:["Hoffenheim", "RB Leipzig"], diff:"expert" \},\
\
  // \'c9quipe nationale Espagne 2026 (compl\'e9ments)\
  \{ name:"Pau Cubars\'ed", clubs:["Barcelona"], diff:"moyen" \},\
  \{ name:"Marc Cucurella", clubs:["Brighton", "Chelsea"], diff:"moyen" \},\
  \{ name:"Mart\'edn Zubimendi", clubs:["Real Sociedad", "Arsenal"], diff:"moyen" \},\
  \{ name:"Unai Sim\'f3n", clubs:["Athletic Bilbao"], diff:"expert" \},\
  \{ name:"Ferm\'edn L\'f3pez", clubs:["Barcelona"], diff:"expert" \},\
\
  // \'c9quipe nationale Portugal 2026 (compl\'e9ments)\
  \{ name:"Francisco Concei\'e7\'e3o", clubs:["Porto", "Juventus"], diff:"moyen" \},\
  \{ name:"Jo\'e3o Palhinha", clubs:["Sporting CP", "Fulham", "Bayern Munich"], diff:"moyen" \},\
  \{ name:"Matheus Nunes", clubs:["Wolverhampton", "Manchester City"], diff:"moyen" \},\
  \{ name:"Nelson Semedo", clubs:["Barcelona", "Wolverhampton", "Fenerbah\'e7e"], diff:"moyen" \},\
\
  // \'c9quipe nationale C\'f4te d'Ivoire 2026\
  ...
  \{ name:"Ibrahim Sangar\'e9", clubs:["PSV Eindhoven", "Nottingham Forest"], diff:"moyen" \},\
  \{ name:"Nicolas P\'e9p\'e9", clubs:["Lille", "Arsenal", "Nice"], diff:"moyen" \},\
  \{ name:"Hassane Kamara", clubs:["Nice", "Watford"], diff:"moyen" \},\
  \{ name:"Willy Boly", clubs:["Porto", "Wolverhampton", "Nottingham Forest"], diff:"moyen" \},\
  \{ name:"Hamed Traor\'e9", clubs:["Sassuolo", "Bournemouth", "Napoli"], diff:"moyen" \},\
  \{ name:"Maxwel Cornet", clubs:["Lyon", "Burnley", "West Ham"], diff:"moyen" \},\
\
  // \'c9quipe nationale Cameroun 2026\
  \{ name:"Andr\'e9-Franck Zambo Anguissa", clubs:["Fulham", "Villarreal", "Napoli"], diff:"moyen" \},\
  ...
  \{ name:"Vincent Aboubakar", clubs:["Porto", "Be\uc0\u351 ikta\u351 ", "Al Nassr"], diff:"moyen" \},\
  \{ name:"Karl Toko Ekambi", clubs:["Angers", "Villarreal", "Lyon"], diff:"moyen" \},\
  \{ name:"Christopher Wooh", clubs:["Lens", "Rennes"], diff:"expert" \},\
  \{ name:"Nathan Ngoumou", clubs:["Toulouse", "Borussia M\'f6nchengladbach"], diff:"expert" \},\
  \{ name:"Martin Hongla", clubs:["Hellas Verona", "Granada"], diff:"expert" \},\
  \{ name:"Jean Onana", clubs:["Bordeaux", "Genoa"], diff:"expert" \},\
\
  // \'c9quipe nationale Afrique du Sud 2026\
  \{ name:"Lyle Foster", clubs:["Monaco", "Burnley"], diff:"moyen" \},\
  \{ name:"Percy Tau", clubs:["Club Brugge", "Brighton", "Al Ahly"], diff:"moyen" \},\
  \{ name:"Bongani Zungu", clubs:["Amiens", "Rangers", "Kas\uc0\u305 mpa\u351 a"], diff:"expert" \},\
\
  // \'c9quipe nationale \'c9gypte 2026\
  \{ name:"Mohamed Elneny", clubs:["Basel", "Arsenal", "Be\uc0\u351 ikta\u351 "], diff:"moyen" \},\
  \{ name:"Mahmoud Trezeguet", clubs:["Kas\uc0\u305 mpa\u351 a", "Aston Villa", "Trabzonspor"], diff:"moyen" \},\
...
\
  // \'c9quipe nationale RD Congo 2026\
  ...
  \{ name:"C\'e9dric Bakambu", clubs:["Sochaux", "Villarreal", "Real Betis"], diff:"moyen" \},\
  ...
  \{ name:"Th\'e9o Bongonda", clubs:["Genk", "Celta Vigo", "Spartak Moscow"], diff:"expert" \},\
  \{ name:"Arthur Masuaku", clubs:["West Ham", "Be\uc0\u351 ikta\u351 ", "Crystal Palace"], diff:"expert" \},\
\
  // \'c9quipe nationale Tunisie 2026\
  ...
  \{ name:"Youssef Msakni", clubs:["Esp\'e9rance de Tunis", "Valenciennes", "Al Duhail"], diff:"expert" \},\
  \{ name:"Aymen Dahmen", clubs:["CS Sfaxien", "Reims"], diff:"expert" \},\
\
  // \'c9quipe nationale France 2026 (compl\'e9ments)\
...
\
  // \'c9quipe nationale S\'e9n\'e9gal 2026\
  \{ name:"Pape Matar Sarr", clubs:["Metz", "Tottenham"], diff:"moyen" \},\
  \{ name:"Kr\'e9pin Diatta", clubs:["Club Brugge", "Monaco"], diff:"moyen" \},\
  \{ name:"Moussa Niakhat\'e9", clubs:["Metz", "Mainz", "Lyon"], diff:"moyen" \},\
...
\
  // \'c9quipe nationale Alg\'e9rie 2026\
  \{ name:"Isma\'ebl Bennacer", clubs:["Empoli", "AC Milan", "Dinamo Zagreb"], diff:"moyen" \},\
  \{ name:"Ramy Bensebaini", clubs:["Nice", "Borussia M\'f6nchengladbach", "Borussia Dortmund"], diff:"moyen" \},\
  \{ name:"Rayan A\'eft-Nouri", clubs:["Angers", "Wolverhampton", "Manchester City"], diff:"moyen" \},\
  \{ name:"Youcef Atal", clubs:["Nice", "Al-Sadd"], diff:"moyen" \},\
  \{ name:"A\'efssa Mandi", clubs:["Reims", "Real Betis", "Villarreal", "Lille"], diff:"moyen" \},\
...
\
  ...
  \{ name:"Romain Sa\'efss", clubs:["Wolverhampton", "Be\uc0\u351 ikta\u351 ", "Al-Sadd"], diff:"moyen" \},\
  ...
  \{ name:"Brahim D\'edaz", clubs:["Manchester City", "Real Madrid", "AC Milan", "PSG"], diff:"moyen" \},\
...
\
  ...
  \{ name:"Ronaldo Naz\'e1rio", clubs:["Cruzeiro", "Barcelona", "Inter Milan", "Real Madrid", "AC Milan"], diff:"facile" \},\
  \{ name:"Kak\'e1", clubs:["AC Milan", "Real Madrid", "Orlando City"], diff:"facile" \},\
  \{ name:"Franck Rib\'e9ry", clubs:["Marseille", "Bayern Munich", "Fiorentina"], diff:"facile" \},\
  ...
  \{ name:"Gon\'e7alo Ramos", clubs:["Benfica", "PSG"], diff:"moyen" \},\
];\
\
export const RETIRED_PLAYERS = new Set([ "Aaron Ramsey","Abedi Pele","Alberto Mendez","Alessandro Del Piero","Alessandro Nesta",\
  ...
  "Andr\'e9 Ayew","Andy Cole","Angel Di Maria","Antonio Cassano","Arjen Robben",\
  ...
  "Florent Malouda","Francesco Totti","Francis Jeffers","Franck Rib\'e9ry","Franco Baresi",\
  ...
  "Iker Casillas","Ivan Peri\'9ai\uc0\u263 ","Ivan Rakitic","James Milner","Jamie Carragher",\
  ...
  "Jordi Alba","Jo\'e3o Moutinho","Juan Mata","Juan Sebastian Veron","Juninho",\
  "Justin Hoyte","J\'fcrgen Klinsmann","Kak\'e1","Karl-Heinz Riedle","Kevin Gameiro",\
  ...
  "Nicolas Mahut","Nicol\'e1s Otamendi","Nii Lamptey","Noe Pamarot","Nwankwo Kanu",\
