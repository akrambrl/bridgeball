export const PLAYERS = [
  ...
  // Man United
  { name:"Rasmus Højlund", clubs:["Copenhagen", "Sturm Graz", "Atalanta", "Manchester United"], diff:"moyen" },
  // Chelsea
  ...
  { name:"Giacomo Raspadori", clubs:["Sassuolo", "Napoli", "Atletico Madrid"], diff:"expert" },
...
{ name:"Steve Mandanda", clubs:["Le Havre", "Marseille", "Crystal Palace", "Rennes"], diff:"moyen" },
  ...
  { name:"Manuel Akanji", clubs:["Winterthur", "Basel", "Borussia Dortmund", "Manchester City"], diff:"moyen" },
  ...
  { name:"Christian Nørgaard", clubs:["Brondby", "Fiorentina", "Brentford", "Arsenal"], diff:"expert" },
  // Manchester United
