export const PLAYERS = [
  ...
  { name:"Anthony Martial", clubs:["Olympique Lyonnais", "AS Monaco", "Manchester United", "Séville FC", "AEK Athènes", "Monterrey"], diff:"moyen" },  { name:"Igor Thiago", clubs:["Club Brugge", "Brentford"], diff:"expert" },
  ...
  { name:"Matheus Cunha", clubs:["RB Leipzig", "Hertha Berlin", "Atlético Madrid", "Wolverhampton", "Manchester United"], diff:"moyen" },  { name:"Eberechi Eze", clubs:["Crystal Palace", "Arsenal"], diff:"moyen" },
