export const PLAYERS = [
  ...
  { name:"Noa Lang", clubs:["Ajax Amsterdam", "Club Brugge", "PSV Eindhoven", "Napoli"], diff:"moyen" },
  ...
  { name:"Kristjan Asllani", clubs:["Empoli", "Inter Milan", "Besiktas"], diff:"expert" },
  ...
  { name:"Maxime Lopez", clubs:["Marseille", "Sassuolo", "Fiorentina", "Paris FC"], diff:"expert" },
  ...
  { name:"Kevin De Bruyne", clubs:["Genk", "Chelsea", "Wolfsburg", "Manchester City", "Napoli"], diff:"facile" },
  ...
  { name:"Bruno Fernandes", clubs:["Novara", "Udinese", "Sampdoria", "Sporting CP", "Manchester United"], diff:"moyen" },
  ...
  { name:"Diego Maradona", clubs:["Argentinos Juniors", "Boca Juniors", "Barcelona", "Napoli", "Sevilla", "Newell's"], diff:"facile" },
  { name:"Zinédine Zidane", clubs:["Cannes", "Bordeaux", "Juventus", "Real Madrid"], diff:"facile" },
  { name:"Gabriel Batistuta", clubs:["River Plate", "Boca Juniors", "Fiorentina", "Roma", "Inter Milan", "Al-Arabi"], diff:"moyen" },
  ...
  { name:"Adam Masina", clubs:["Bologna", "Watford", "Udinese", "Torino"], diff:"expert" },
  ...
  { name:"Rachid Ghezzal", clubs:["Lyon", "Monaco", "Leicester City", "Fiorentina", "Besiktas", "Tigres UANL"], diff:"expert" },
  ...
  { name:"Pablo Marì", clubs:["Mallorca", "NAC Breda", "Manchester City", "Deportivo La Coruna", "Flamengo", "Arsenal", "Udinese", "Monza", "Fiorentina", "Al Hilal"], diff:"moyen" },
  { name:"Edoardo Bove", clubs:["Roma", "Fiorentina", "Watford"], diff:"expert" },
  { name:"Jack Harrison", clubs:["Manchester United", "Manchester City", "Middlesbrough", "Leeds United", "Everton", "Fiorentina"], diff:"moyen" },
  { name:"Daniele Rugani", clubs:["Empoli", "Juventus", "Cagliari", "Rennes", "Ajax Amsterdam", "Fiorentina"], diff:"moyen" },
  { name:"Bryan Zaragoza", clubs:["Granada", "Bayern Munich", "Osasuna", "Celta Vigo", "Roma"], diff:"expert" },
  { name:"Simon Sohm", clubs:["Zürich", "Parme", "Fiorentina", "Bologna"], diff:"expert" },
  { name:"João Mário Neto", clubs:["Porto", "Juventus", "Bologna"], diff:"expert" },
  { name:"Marco Brescianini", clubs:["AC Milan", "Virtus Entella", "Cosenza", "Frosinone", "Atalanta", "Fiorentina"], diff:"expert" },
  { name:"Emil Holm", clubs:["Spezia", "Atalanta", "Bologna", "Juventus"], diff:"expert" },
  ...
  // Liga
  { name:"Renato Veiga", clubs:["Sporting CP", "Basel", "Chelsea", "Juventus", "Villarreal"], diff:"moyen" },
  ...
  { name:"Timothy Weah", clubs:["PSG", "Celtic", "Lille", "Juventus", "Marseille"], diff:"moyen" },
  ...
  { name:"Hans Hateboer", clubs:["Groningen", "Atalanta", "Rennes", "Lyon"], diff:"expert" },
  // Lille - été 2025
  ...
  { name:"Christian Nørgaard", clubs:["Brøndby", "Hamburger SV", "Fiorentina", "Brentford", "Arsenal"], diff:"moyen" },
  ...
  { name:"Jaka Bijol", clubs:["Rudar Velenje", "CSKA Moscow", "Hannover", "Udinese", "Leeds United"], diff:"expert" },
  ...
  { name:"David Hancko", clubs:["Žilina", "Fiorentina", "Sparta Prague", "Feyenoord", "Atletico Madrid"], diff:"moyen" },
  { name:"Matteo Ruggeri", clubs:["Atalanta", "Salernitana", "Atletico Madrid"], diff:"expert" },
  ...
  { name:"Giacomo Raspadori", clubs:["Sassuolo", "Napoli", "Atletico Madrid"], diff:"moyen" },
  // Serie A été 2025 - manquants
  { name:"Edon Zhegrova", clubs:["Genk", "Basel", "Lille", "Juventus"], diff:"expert" },
  { name:"Wesley Franca", clubs:["Flamengo", "Roma"], diff:"expert" },
  { name:"Ange-Yoan Bonny", clubs:["Châteauroux", "Parma", "Inter Milan"], diff:"expert" },
  ...
  { name:"Kamaldeen Sulemana", clubs:["Right to Dream", "Nordsjælland", "Rennes", "Southampton", "Atalanta"], diff:"moyen" },
  { name:"Nikola Krstovic", clubs:["Zeta", "Dunajská Streda", "Lecce", "Atalanta"], diff:"expert" },
  { name:"Petar Ratkov", clubs:["Crvena Zvezda", "Salzburg", "Lazio"], diff:"expert" },
  { name:"Vanja Milinkovic-Savic", clubs:["Crvena Zvezda", "Lechia Gdańsk", "Torino", "Napoli"], diff:"expert" },
  ...
  { name:"Stefan Posch", clubs:["Bologna", "Hoffenheim", "Como", "Mainz"], diff:"expert" },
  ...
  // Tottenham
  { name:"Guglielmo Vicario", clubs:["Udinese", "Venezia", "Perugia", "Cagliari", "Empoli", "Tottenham"], diff:"moyen" },
  { name:"Radu Drăguşin", clubs:["Juventus", "Sampdoria", "Salernitana", "Genoa", "Tottenham"], diff:"expert" },
  { name:"Djed Spence", clubs:["Middlesbrough", "Nottingham Forest", "Tottenham", "Rennes", "Leeds United", "Genoa"], diff:"expert" },
  { name:"Dejan Kulusevski", clubs:["Atalanta", "Parma", "Juventus", "Tottenham"], diff:"moyen" },
  // Newcastle
  ...
  { name:"Emerson Palmieri", clubs:["Santos", "Palermo", "Roma", "Chelsea", "Lyon", "West Ham"], diff:"moyen" },
  ...
  { name:"Andreas Pereira", clubs:["Manchester United", "Granada", "Valencia", "Lazio", "Flamengo", "Fulham", "Palmeiras"], diff:"moyen" },
  ...
  // Bournemouth
  { name:"Lloyd Kelly", clubs:["Bristol City", "Bournemouth", "Juventus", "Newcastle"], diff:"expert" },
  ...
  { name:"Beto", clubs:["Portimonense", "Udinese", "Everton"], diff:"expert" },
  ...
  { name:"Mario Lemina", clubs:["Marseille", "Juventus", "Southampton", "Galatasaray", "Fulham", "Nice", "Wolverhampton"], diff:"moyen" },
  ...
  { name:"Nicolas Domínguez", clubs:["Vélez Sarsfield", "Bologna", "Hellas Verona", "Nottingham Forest"], diff:"expert" },
  // Leicester
  ...
  { name:"Alessandro Altobelli", clubs:["Brescia", "Inter Milan", "Juventus"], diff:"expert" },
  ...
  { name:"Nicolo Barella", clubs:["Cagliari", "Como", "Inter Milan"], diff:"moyen" },
  { name:"Khvicha Kvaratskhelia", clubs:["Rustavi","Dinamo Tbilisi","Rubin Kazan","Dinamo Batumi","Napoli","PSG"], diff:"moyen" },
  { name:"Jonathan David", clubs:["Gent", "Lille", "Juventus"], diff:"moyen" },
  ...
  { name:"Pedro Neto", clubs:["Braga", "Lazio", "Wolverhampton", "Chelsea"], diff:"moyen" },
  ...
  { name:"Ciro Immobile", clubs:["Juventus", "Torino", "Borussia Dortmund", "Sevilla", "Lazio", "Besiktas", "Bologna", "Paris FC"], diff:"moyen" },
  ...
  { name:"David de Gea", clubs:["Atletico Madrid", "Manchester United", "Fiorentina"], diff:"moyen" },
  ...
  { name:"Filippo Inzaghi", clubs:["Piacenza", "Parma", "Atalanta", "Juventus", "AC Milan"], diff:"moyen" },
  ...
  { name:"Alisson", clubs:["Internacional", "Roma", "Liverpool"], diff:"moyen" },
...
{ name:"Steve Mandanda", clubs:["Le Havre", "Marseille", "Crystal Palace", "Rennes"], diff:"moyen" },
  ...
  { name:"Kyle Walker", clubs:["Sheffield United", "Tottenham", "Aston Villa", "QPR", "Manchester City", "Milan"], diff:"moyen" },
  ...
  { name:"Rodrigo Bentancur", clubs:["Boca Juniors", "Juventus", "Tottenham"], diff:"moyen" },
  ...
  { name:"Rodrigo De Paul", clubs:["Udinese", "Atletico Madrid", "Inter Miami"], diff:"moyen" },
  ...
  { name:"Donyell Malen", clubs:["PSV Eindhoven", "Borussia Dortmund", "Aston Villa", "Roma"], diff:"moyen" },
  ...
  { name:"Joshua Zirkzee", clubs:["Bayern Munich", "Parma", "Anderlecht", "Bologna", "Manchester United"], diff:"moyen" },
  ...
  { name:"Riccardo Calafiori", clubs:["Roma", "Genoa", "Basel", "Bologna", "Arsenal"], diff:"moyen" },
  { name:"Giovanni Di Lorenzo", clubs:["Empoli", "Napoli"], diff:"moyen" },
  { name:"Andrea Cambiaso", clubs:["Genoa", "Juventus"], diff:"moyen" },
  { name:"Destiny Udogie", clubs:["Hellas Verona", "Udinese", "Tottenham"], diff:"moyen" },
  { name:"Lorenzo Pellegrini", clubs:["Roma Primavera", "Sassuolo", "Roma"], diff:"moyen" },
  ...
  { name:"Lois Openda", clubs:["Club Brugge", "Vitesse", "Lens", "RB Leipzig", "Juventus"], diff:"moyen" },
  ...
  { name:"Evan Ndicka", clubs:["Auxerre", "Eintracht Frankfurt", "Roma"], diff:"moyen" },
  ...
  { name:"Hamed Traoré", clubs:["Empoli", "Sassuolo", "Bournemouth", "Napoli", "Auxerre", "Marseille"], diff:"moyen" },
  ...
  { name:"Jean Onana", clubs:["Lille", "Bordeaux", "Besiktas", "Marseille", "Genoa"], diff:"expert" },
  ...
  { name:"Ismaël Bennacer", clubs:["Arsenal", "Empoli", "AC Milan", "Marseille", "Dinamo Zagreb"], diff:"moyen" },
  ...
  { name:"Edin Dzeko", clubs:["Wolfsburg", "Manchester City", "Roma", "Inter Milan", "Fenerbahce", "Fiorentina", "Schalke"], diff:"facile" },
  ...
  { name:"Leon Bailey", clubs:["Genk", "Bayer Leverkusen", "Aston Villa", "Roma"], diff:"moyen" },
  ...
  { name:"Kevin-Prince Boateng", clubs:["Hertha Berlin", "Tottenham", "Borussia Dortmund", "Portsmouth", "AC Milan", "Schalke", "Las Palmas", "Eintracht Frankfurt", "Sassuolo", "Barcelona", "Fiorentina", "Besiktas", "Monza"], diff:"moyen" },
  ...
  // Barcelona
  { name:"Pep Guardiola", clubs:["Barcelona", "Brescia", "Roma", "Al-Ahli", "Dorados"], diff:"moyen" },
  ...
  { name:"Miralem Pjanić", clubs:["Metz", "Lyon", "Roma", "Juventus", "Barcelona", "Besiktas", "Sharjah", "CSKA Moscow"], diff:"moyen" },
  ...
  { name:"Nikola Milenković", clubs:["Partizan", "Fiorentina", "Nottingham Forest"], diff:"moyen" },
  // Gardiens / divers
  ...
  { name:"Martín Satriano", clubs:["Nacional", "Inter Milan", "Brest", "Empoli", "Lens", "Lyon", "Getafe"], diff:"expert" },
  ...
  { name:"Jérémie Boga", clubs:["Chelsea", "Rennes", "Birmingham", "Granada", "Sassuolo", "Atalanta", "Nice", "Juventus"], diff:"moyen" },
  ...
  { name:"Dávid Hancko", clubs:["Fiorentina", "Sparta Prague", "Feyenoord", "Atletico Madrid"], diff:"expert" },
  ...
  { name:"Manor Solomon", clubs:["Maccabi Petah Tikva", "Maccabi Tel Aviv", "Shakhtar Donetsk", "Fulham", "Tottenham", "Leeds United", "Villarreal", "Fiorentina"], diff:"expert" },
  // Mercato Serie A 2025-26 - joueurs manquants
  { name:"Nikola Krstović", clubs:["Podgorica", "Dunajska Streda", "Lecce", "Atalanta"], diff:"expert" },
  { name:"Koni De Winter", clubs:["Juventus", "Sampdoria", "Empoli", "Genoa", "AC Milan"], diff:"expert" },
  ...
  { name:"Roberto Piccoli", clubs:["Atalanta", "Verona", "Genoa", "Spezia", "Lecce", "Cagliari", "Fiorentina"], diff:"expert" },
  { name:"Samuele Ricci", clubs:["Empoli", "Torino", "AC Milan"], diff:"expert" },
  { name:"Dusan Vlahovic", clubs:["Partizan", "Fiorentina", "Juventus"], diff:"moyen" },
  { name:"Jonathan Rowe", clubs:["Norwich", "Marseille", "Bologna"], diff:"moyen" },
  { name:"Sam Beukema", clubs:["Go Ahead Eagles", "AZ Alkmaar", "Bologna", "Napoli"], diff:"expert" },
  { name:"Dan Ndoye", clubs:["Lausanne", "Nice", "Basel", "Bologna", "Nottingham Forest"], diff:"moyen" },
  { name:"Nicolás González", clubs:["Argentinos Juniors", "Stuttgart", "Fiorentina", "Juventus", "Atletico Madrid"], diff:"moyen" },
  { name:"Noah Okafor", clubs:["Basel", "Salzburg", "AC Milan", "Napoli", "Leeds United"], diff:"moyen" },
  ...
  { name:"Yunus Musah", clubs:["Valencia", "AC Milan", "Atalanta"], diff:"moyen" },
  ...
  { name:"Nicolò Fagioli", clubs:["Juventus", "Cremonese", "Fiorentina"], diff:"moyen" },
  { name:"Robin Gosens", clubs:["Heracles", "Atalanta", "Inter Milan", "Union Berlin", "Fiorentina"], diff:"moyen" },
  ...
  { name:"Giovanni Leoni", clubs:["Padova", "Sampdoria", "Parma", "Liverpool"], diff:"expert" },
  // Arsenal
  ...
  { name:"Michael Kayode", clubs:["Gozzano", "Fiorentina", "Brentford"], diff:"expert" },
  ...
  // Benfica
  { name:"Enzo Barrenechea", clubs:["Newell's", "Juventus", "Sion", "Frosinone", "Aston Villa", "Valencia", "Benfica"], diff:"expert" },
  ...
  { name:"Yann Karamoh", clubs:["Inter Milan", "Bordeaux", "Parme", "Torino", "Montpellier", "Porto"], diff:"moyen" },
  // Sporting CP
  ...
  // Ajax
  { name:"Raul Moro", clubs:["Lazio", "Real Valladolid", "Ajax Amsterdam", "Osasuna"], diff:"expert" },
  // PSV
  ...
  { name:"Jerdy Schouten", clubs:["Excelsior", "Bologna", "PSV Eindhoven"], diff:"expert" },
  // Feyenoord
  ...
  { name:"Tiago Djaló", clubs:["Milan", "Sporting CP", "Lille", "Juventus", "Porto", "Besiktas"], diff:"expert" },
  ...
  { name:"Sergej Milinković-Savić", clubs:["Vojvodina", "Genk", "Lazio", "Al Hilal"], diff:"moyen" },
  ...
  // Atlanta United
  { name:"Emmanuel Latte Lath", clubs:["Atalanta", "Middlesbrough", "Atlanta United"], diff:"expert" },
  // FC Cincinnati
