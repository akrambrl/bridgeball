...
function getFaq(): { q: string; a: string }[] {
  return [
    ...
    {
      q: tr("Quelle différence entre amateur, pro, légende, GOAT ?", "What's the difference between amateur, pro, legend, GOAT?", "Was ist der Unterschied zwischen Amateur, Pro, Legende, GOAT?", "Che differenza c'è tra amatore, pro, leggenda, GOAT?", "Qual a diferença entre amador, pro, lenda, GOAT?","¿Qué diferencia hay entre amateur, pro, leyenda y GOAT?"),
      a: tr("Ce sont les paliers de progression basés sur ton score. Plus tu joues bien, plus tu montes — jusqu'au statut suprême de GOAT.", "They're the progression tiers based on your score. The better you play, the higher you climb — up to the supreme GOAT status.", "Das sind die Aufstiegsstufen nach deinem Score. Je besser du spielst, desto höher steigst du — bis zum höchsten GOAT-Status.", "Sono i livelli di progressione basati sul punteggio. Più giochi bene, più sali — fino allo status supremo di GOAT.", "São os níveis de progressão baseados na sua pontuação. Quanto melhor você joga, mais sobe — até o status supremo de GOAT.","Son los niveles de progresión según tu puntuación. Cuanto mejor juegues, más subes — hasta el estatus supremo de GOAT."),
    },
    {
