...
,
  ...
  { name:"Dennis Bergkamp", clubs:["Ajax", "Inter Milan", "Arsenal"], diff:"facile" },
  { name:"Edgar Davids", clubs:["Ajax", "Juventus", "Barcelona", "Inter Milan"], diff:"moyen" },
  { name:"Klaas-Jan Huntelaar", clubs:["Ajax", "Real Madrid", "AC Milan"], diff:"moyen" },
  { name:"Ryan Babel", clubs:["Ajax", "Liverpool", "Galatasaray"], diff:"moyen" },
  // Russie
