...
// ── LES LÉGENDES ───────────────────────────────────────────────────────────
//
// Écrites ici et pas laissées à improviser au moment de poster. Deux choses s'y
// jouent que le visuel ne peut pas porter : l'appel à l'action, et les mentions
// obligatoires — c'est la LÉGENDE qui est lue, et une image recadrée par la
// plateforme peut rogner ce qu'elle porte.
//
// Le compte à rebours est écrit en DATE et non en « J-15 ». Une légende
// vieillit dans le fil : « il te reste 15 jours » devient faux le lendemain,
// alors que « le 1er septembre » reste vrai pour toujours. Les deux semaines
// sont dites en relatif ET la date en absolu, pour que le post tienne s'il est
// republié.
const LEGENDES = {
  "1-le-podium": `🏆 LE 1ER SEPTEMBRE, TOUT LE MONDE REPART À ZÉRO.

Le classement mensuel de GOAT FC est remis à zéro — et cette fois, les trois premiers repartent avec quelque chose :

🥇 EA SPORTS FC 27, édition Ultimate (109,99 €), sur la plateforme de ton choix
🥈 Une carte cadeau de 50 €, enseigne de ton choix
🥉 Une carte cadeau de 30 €, enseigne de ton choix

Il te reste deux semaines pour t'entraîner. Le classement compte ton meilleur score du jour dans chaque mode, jour après jour : ça ne se gagne pas en une soirée, ça se gagne en revenant. Autant prendre le pli maintenant.

👉 Ça se joue sur goatfc.fr — gratuit, rien à installer.

⚠️ POUR ÊTRE ÉLIGIBLE AUX LOTS :
1️⃣ Abonne-toi à ${COMPTE_IG}
2️⃣ Identifie 2 amis en commentaire
3️⃣ Partage ce post en story

Le classement décide de l'ordre ; ces 3 gestes sont vérifiés au moment de la remise.

Concours de connaissances sans obligation d'achat. Règlement complet sur goatfc.fr/reglement. Jeu non sponsorisé, administré ni associé à Instagram. Trois lots dématérialisés, plateforme ou enseigne au choix des gagnants. EA SPORTS FC 27 est une marque d'Electronic Arts Inc., qui n'est ni organisateur, ni sponsor, ni partenaire de ce concours.

#football #foot #quizfoot #culturefoot #mercato #ligue1 #premierleague #fc27 #jeuconcours #concours #footballfrance #goatfc`,

  "2-le-jeu": `⚽ SIX MODES, ZÉRO INSTALLATION.

Trouver le joueur qui relie deux clubs. Reconstituer un parcours à partir des maillots. Enchaîner les clubs sans t'arrêter. Deviner le joueur du jour en 6 essais.

Ton meilleur score du jour compte dans chaque mode, et tout s'additionne sur le mois. Rejouer vingt fois le même mode ne rapporte rien de plus : c'est la régularité qui gagne.

Le classement repart à zéro le 1er septembre — deux semaines pour prendre le pli.

👉 goatfc.fr, dans ton navigateur.

⚠️ Pour être éligible aux lots : abonne-toi à ${COMPTE_IG}, identifie 2 amis en commentaire et partage ce post en story.

Concours de connaissances sans obligation d'achat. Règlement complet sur goatfc.fr/reglement. Jeu non sponsorisé, administré ni associé à Instagram.

#football #foot #quizfoot #culturefoot #mercato #ligue1 #premierleague #jeuconcours #footballfrance #goatfc`,

  "3-pour-gagner": `📋 LES CONDITIONS, EN CLAIR.

1️⃣ Joue sur goatfc.fr — gratuit, rien à installer
2️⃣ Abonne-toi à ${COMPTE_IG}
3️⃣ Identifie 2 amis en commentaire de ce post
4️⃣ Partage ce post en story, et laisse-la en ligne

Le concours court du 1er au 30 septembre, heure de Paris. Le classement décide de l'ordre des trois places ; les trois gestes Instagram sont vérifiés au moment de la remise du lot.

Tu as deux semaines avant le départ pour t'entraîner. Tout le monde repart à zéro le 1er, que tu joues depuis avril ou que tu découvres l'app aujourd'hui.

🥇 FC 27 édition Ultimate (109,99 €) · 🥈 50 € · 🥉 30 €

Concours de connaissances sans obligation d'achat. Règlement complet sur goatfc.fr/reglement. Jeu non sponsorisé, administré ni associé à Instagram. Trois lots dématérialisés, plateforme ou enseigne au choix des gagnants.

#football #foot #quizfoot #culturefoot #jeuconcours #concours #ligue1 #premierleague #footballfrance #goatfc`,
};

async function ecrireLegendes() {
  const bouts = ["# Légendes des trois posts", "",
    "Générées par `npm run posts`. Les mentions obligatoires sont AUSSI sur",
    "l'image : la légende les répète parce que c'est elle qui est lue, et parce",
    "qu'une image se partage seule.", "",
    "**Sur les hashtags.** Douze, pas trente. Instagram range un post par ce",
    "qu'il contient bien plus que par sa liste de mots-clés, et trente hashtags",
    "génériques ressemblent surtout à du remplissage. Ceux-ci mêlent trois",
    "tailles : très larges (#football, #foot), moyens et ciblés (#quizfoot,",
    "#culturefoot, #mercato), et la marque (#goatfc).", "",
    "**Ce qui n'y est PAS, volontairement :** aucun hashtag de marque d'EA",
    "(#easportsfc et compagnie). Nommer le lot est un usage légitime ; se ranger",
    "sous la bannière de l'éditeur suggère un partenariat qui n'existe pas, et",
    "c'est exactement ce que la mention de non-affiliation dément deux lignes",
    "plus haut.", ""];
  for (const p of POSTS) {
    bouts.push("## " + p.fichier, "", "```", LEGENDES[p.fichier] || "", "```", "");
  }
